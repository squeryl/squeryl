...
by name equivalence. It is possible to override a correspondance 
with the org.squeryl.annotations.Row and org.squeryl.annotations.Column
annotations.
...
class Patient(firstName: FirstName, age: Age, weight: WeightInKilograms)
