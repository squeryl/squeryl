...
h3. The recommended version is 0.9.4

Supported Scala versions are Scala2.9.0-1, Scala2.9.0, Scala2.8.1 and Scala2.8.0
...
You can use this example as a template to get started :

"http://github.com/pbrant/squeryl_sbt_minimal_example":http://github.com/pbrant/squeryl_sbt_minimal_example
...
....
[info]    using ExampleProject with sbt 0.7.7 and Scala 2.7.7
...
* The Scala runtime jar, version 2.9.0-1 (or 2.9.0, 2.8.1, 2.8.0)
