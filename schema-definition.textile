...
|_. Java/JDBC  |_. Oracle     |_. PostgreSql     |_. DB2       |_. MySql    |_. H2       |
| int          | number      | integer          | int         | int        | int        |
| long         | number      | bigint           | bigint      | bigint     | bigint     |
| float        | float       | real             | real        | float      | real       |
| double       | real        | double precision | double      | double     | double     |
| BidDecimal   | decimal     | numeric          | decimal     | decimal    | decimal    |
| String       | varchar2(x) | varchar(x)       | varchar(x)  | varchar(x) | varchar(x) |
| Date         | date        | date             | date        | date       | date       |
| Timestamp    | date        | timestamp        | timestamp   | datetime   | timestamp  |
| byte[]       | blob        | bytea            | blob        | blob       | binary     |
