...
<script type="syntaxhighlighter" class="brush: scala"><![CDATA[
  ...
  class SHA1(e: StringExpression[String], m:OutMapper[String]) 
    extends FunctionNode[String]("sha1", Some(m), e) with StringExpression[String]
...
<script type="syntaxhighlighter" class="brush: scala"><![CDATA[
  ...
  val m1:OutMapper[String] = new OutMapper[String] {
    def doMap(rs: ResultSet) = rs.getString(index)
    def sample = ""
  }
    
  class SHA1(e: StringExpression[String]) 
    extends FunctionNode[String]("sha1", Some(m1), e) with StringExpression[String]

  def sha1(e: StringExpression[String]) = new SHA1(e,m)
  
  val m2:OutMapper[Option[StringType]] = new OutMapper[Option[String]] {
