...
trait PrimitiveTypeMode extends QueryDsl with FieldMapper {
  ...
  implicit val localDateTEF: TypedExpressionFactory[LocalDate, TLocalDate] with PrimitiveJdbcMapper[LocalDate] = PrimitiveTypeSupport.localDateTEF
  implicit val optionLocalDateTEF: TypedExpressionFactory[Option[LocalDate], TOptionLocalDate] with DeOptionizer[LocalDate, LocalDate, TLocalDate, Option[LocalDate], TOptionLocalDate] = PrimitiveTypeSupport.optionLocalDateTEF
  implicit val localTimeTEF: TypedExpressionFactory[LocalTime, TLocalTime] with PrimitiveJdbcMapper[LocalTime] = PrimitiveTypeSupport.localTimeTEF
  implicit val optionLocalTimeTEF: TypedExpressionFactory[Option[LocalTime], TOptionLocalTime] with DeOptionizer[LocalTime, LocalTime, TLocalTime, Option[LocalTime], TOptionLocalTime] = PrimitiveTypeSupport.optionLocalTimeTEF
  ...
  implicit val optionLocalDateTimeTEF: TypedExpressionFactory[Option[LocalDateTime], TOptionLocalDateTime] with DeOptionizer[LocalDateTime, LocalDateTime, TLocalDateTime, Option[LocalDateTime], TOptionLocalDateTime] = PrimitiveTypeSupport.optionLocalDateTimeTEF
  implicit val offsetTimeTEF: TypedExpressionFactory[OffsetTime, TOffsetTime] with PrimitiveJdbcMapper[OffsetTime] = PrimitiveTypeSupport.offsetTimeTEF
  implicit val optionOffsetTimeTEF: TypedExpressionFactory[Option[OffsetTime], TOptionOffsetTime] with DeOptionizer[OffsetTime, OffsetTime, TOffsetTime, Option[OffsetTime], TOptionOffsetTime] = PrimitiveTypeSupport.optionOffsetTimeTEF
  implicit val instantTEF: NonPrimitiveJdbcMapper[OffsetDateTime, Instant, TInstant] = PrimitiveTypeSupport.instantTEF
  implicit val optionInstantTEF: TypedExpressionFactory[Option[Instant], TOptionInstant] with DeOptionizer[OffsetDateTime, Instant, TInstant, Option[Instant], TOptionInstant] = PrimitiveTypeSupport.optionInstantTEF
  implicit val offsetDateTimeTEF: TypedExpressionFactory[OffsetDateTime, TOffsetDateTime] with PrimitiveJdbcMapper[OffsetDateTime] = PrimitiveTypeSupport.offsetDateTimeTEF
  implicit val optionOffsetDateTimeTEF: TypedExpressionFactory[Option[OffsetDateTime], TOptionOffsetDateTime] with DeOptionizer[OffsetDateTime, OffsetDateTime, TOffsetDateTime, Option[OffsetDateTime], TOptionOffsetDateTime] = PrimitiveTypeSupport.optionOffsetDateTimeTEF
  ...
  implicit def optionLocalDateToTE(s: Option[LocalDate]): TypedExpression[Option[LocalDate], TOptionLocalDate] = optionLocalDateTEF.create(s)

  implicit def localTimeToTE(s: LocalTime): TypedExpression[LocalTime, TLocalTime] = localTimeTEF.create(s)
  implicit def optionLocalTimeToTE(s: Option[LocalTime]): TypedExpression[Option[LocalTime], TOptionLocalTime] = optionLocalTimeTEF.create(s)
  ...
  implicit def localDateTimeToTE(s: LocalDateTime): TypedExpression[LocalDateTime, TLocalDateTime] = localDateTimeTEF.create(s)
  implicit def optionLocalDateTimeToTE(s: Option[LocalDateTime]): TypedExpression[Option[LocalDateTime], TOptionLocalDateTime] = optionLocalDateTimeTEF.create(s)

  implicit def offsetTimeToTE(s: OffsetTime): TypedExpression[OffsetTime, TOffsetTime] = offsetTimeTEF.create(s)
  implicit def optionOffsetTimeToTE(s: Option[OffsetTime]): TypedExpression[Option[OffsetTime], TOptionOffsetTime] = optionOffsetTimeTEF.create(s)

  implicit def instantToTE(s: Instant): TypedExpression[Instant, TInstant] = instantTEF.create(s)

  implicit def optionInstantToTE(s: Option[Instant]): TypedExpression[Option[Instant], TOptionInstant] = optionInstantTEF.create(s)

  implicit def offsetDateTimeToTE(s: OffsetDateTime): TypedExpression[OffsetDateTime, TOffsetDateTime] = offsetDateTimeTEF.create(s)
  implicit def optionOffsetDateTimeToTE(s: Option[OffsetDateTime]): TypedExpression[Option[OffsetDateTime], TOptionOffsetDateTime] = optionOffsetDateTimeTEF.create(s)

  implicit def zonedDateTimeToInstantTE(s: ZonedDateTime): TypedExpression[Instant, TInstant] = instantTEF.create(s.toInstant)
  implicit def optionZonedDateTimeToInstantTE(s: Some[ZonedDateTime]): TypedExpression[Option[Instant], TOptionInstant] = optionInstantTEF.create(s.map(_.toInstant))
  ...
  implicit def queryOptionLocalDateToTE(q: Query[Option[LocalDate]]): QueryValueExpressionNode[Option[LocalDate], TOptionLocalDate] =
  ...
  implicit def queryLocalDateGroupedToTE(q: Query[Group[LocalDate]]): QueryValueExpressionNode[LocalDate, TLocalDate] =
    new QueryValueExpressionNode[LocalDate, TLocalDate](q.copy(false, Nil).ast, localDateTEF.createOutMapper)
  implicit def queryOptionLocalDateGroupedToTE(q: Query[Group[Option[LocalDate]]]): QueryValueExpressionNode[Option[LocalDate], TOptionLocalDate] =
    new QueryValueExpressionNode[Option[LocalDate], TOptionLocalDate](q.copy(false, Nil).ast, optionLocalDateTEF.createOutMapper)
  implicit def queryLocalDateMeasuredToTE(q: Query[Measures[LocalDate]]): QueryValueExpressionNode[LocalDate, TLocalDate] =
    new QueryValueExpressionNode[LocalDate, TLocalDate](q.copy(false, Nil).ast, localDateTEF.createOutMapper)
  implicit def queryOptionLocalDateMeasuredToTE(q: Query[Measures[Option[LocalDate]]]): QueryValueExpressionNode[Option[LocalDate], TOptionLocalDate] =
    new QueryValueExpressionNode[Option[LocalDate], TOptionLocalDate](q.copy(false, Nil).ast, optionLocalDateTEF.createOutMapper)
  ...
  implicit def queryOptionLocalTimeToTE(q: Query[Option[LocalTime]]): QueryValueExpressionNode[Option[LocalTime], TOptionLocalTime] =
  ...
  implicit def queryLocalTimeGroupedToTE(q: Query[Group[LocalTime]]): QueryValueExpressionNode[LocalTime, TLocalTime] =
    new QueryValueExpressionNode[LocalTime, TLocalTime](q.copy(false, Nil).ast, localTimeTEF.createOutMapper)
  implicit def queryOptionLocalTimeGroupedToTE(q: Query[Group[Option[LocalTime]]]): QueryValueExpressionNode[Option[LocalTime], TOptionLocalTime] =
    new QueryValueExpressionNode[Option[LocalTime], TOptionLocalTime](q.copy(false, Nil).ast, optionLocalTimeTEF.createOutMapper)
  implicit def queryLocalTimeMeasuredToTE(q: Query[Measures[LocalTime]]): QueryValueExpressionNode[LocalTime, TLocalTime] =
    new QueryValueExpressionNode[LocalTime, TLocalTime](q.copy(false, Nil).ast, localTimeTEF.createOutMapper)
  implicit def queryOptionLocalTimeMeasuredToTE(q: Query[Measures[Option[LocalTime]]]): QueryValueExpressionNode[Option[LocalTime], TOptionLocalTime] =
    new QueryValueExpressionNode[Option[LocalTime], TOptionLocalTime](q.copy(false, Nil).ast, optionLocalTimeTEF.createOutMapper)
  ...
  implicit def queryLocalDateTimeToTE(q: Query[LocalDateTime]): QueryValueExpressionNode[LocalDateTime, TLocalDateTime] =
    new QueryValueExpressionNode[LocalDateTime, TLocalDateTime](q.copy(false, Nil).ast, localDateTimeTEF.createOutMapper)
  implicit def queryOptionLocalDateTimeToTE(q: Query[Option[LocalDateTime]]): QueryValueExpressionNode[Option[LocalDateTime], TOptionLocalDateTime] =
  ...
  implicit def queryLocalDateTimeGroupedToTE(q: Query[Group[LocalDateTime]]): QueryValueExpressionNode[LocalDateTime, TLocalDateTime] =
    new QueryValueExpressionNode[LocalDateTime, TLocalDateTime](q.copy(false, Nil).ast, localDateTimeTEF.createOutMapper)
  implicit def queryOptionLocalDateTimeGroupedToTE(q: Query[Group[Option[LocalDateTime]]]): QueryValueExpressionNode[Option[LocalDateTime], TOptionLocalDateTime] =
    new QueryValueExpressionNode[Option[LocalDateTime], TOptionLocalDateTime](q.copy(false, Nil).ast, optionLocalDateTimeTEF.createOutMapper)
  implicit def queryLocalDateTimeMeasuredToTE(q: Query[Measures[LocalDateTime]]): QueryValueExpressionNode[LocalDateTime, TLocalDateTime] =
    new QueryValueExpressionNode[LocalDateTime, TLocalDateTime](q.copy(false, Nil).ast, localDateTimeTEF.createOutMapper)
  implicit def queryOptionLocalDateTimeMeasuredToTE(q: Query[Measures[Option[LocalDateTime]]]): QueryValueExpressionNode[Option[LocalDateTime], TOptionLocalDateTime] =
    new QueryValueExpressionNode[Option[LocalDateTime], TOptionLocalDateTime](q.copy(false, Nil).ast, optionLocalDateTimeTEF.createOutMapper)
  ...
  implicit def queryOptionOffsetTimeToTE(q: Query[Option[OffsetTime]]): QueryValueExpressionNode[Option[OffsetTime], TOptionOffsetTime] =
  ...
  implicit def queryOffsetTimeGroupedToTE(q: Query[Group[OffsetTime]]): QueryValueExpressionNode[OffsetTime, TOffsetTime] =
    new QueryValueExpressionNode[OffsetTime, TOffsetTime](q.copy(false, Nil).ast, offsetTimeTEF.createOutMapper)
  implicit def queryOptionOffsetTimeGroupedToTE(q: Query[Group[Option[OffsetTime]]]): QueryValueExpressionNode[Option[OffsetTime], TOptionOffsetTime] =
    new QueryValueExpressionNode[Option[OffsetTime], TOptionOffsetTime](q.copy(false, Nil).ast, optionOffsetTimeTEF.createOutMapper)
  implicit def queryOffsetTimeMeasuredToTE(q: Query[Measures[OffsetTime]]): QueryValueExpressionNode[OffsetTime, TOffsetTime] =
    new QueryValueExpressionNode[OffsetTime, TOffsetTime](q.copy(false, Nil).ast, offsetTimeTEF.createOutMapper)
  implicit def queryOptionOffsetTimeMeasuredToTE(q: Query[Measures[Option[OffsetTime]]]): QueryValueExpressionNode[Option[OffsetTime], TOptionOffsetTime] =
    new QueryValueExpressionNode[Option[OffsetTime], TOptionOffsetTime](q.copy(false, Nil).ast, optionOffsetTimeTEF.createOutMapper)
  ...
  implicit def queryOptionInstantToTE(q: Query[Option[Instant]]): QueryValueExpressionNode[Option[Instant], TOptionInstant] =
  ...
  implicit def queryOptionInstantGroupedToTE(q: Query[Group[Option[Instant]]]): QueryValueExpressionNode[Option[Instant], TOptionInstant] =
    new QueryValueExpressionNode[Option[Instant], TOptionInstant](q.copy(false, Nil).ast, optionInstantTEF.createOutMapper)

  implicit def queryInstantMeasuredToTE(q: Query[Measures[Instant]]): QueryValueExpressionNode[Instant, TInstant] =
    new QueryValueExpressionNode[Instant, TInstant](q.copy(false, Nil).ast, instantTEF.createOutMapper)

  implicit def queryOptionInstantMeasuredToTE(q: Query[Measures[Option[Instant]]]): QueryValueExpressionNode[Option[Instant], TOptionInstant] =
    new QueryValueExpressionNode[Option[Instant], TOptionInstant](q.copy(false, Nil).ast, optionInstantTEF.createOutMapper)

  implicit def queryOffsetDateTimeToTE(q: Query[OffsetDateTime]): QueryValueExpressionNode[OffsetDateTime, TOffsetDateTime] =
    new QueryValueExpressionNode[OffsetDateTime, TOffsetDateTime](q.copy(false, Nil).ast, offsetDateTimeTEF.createOutMapper)
  implicit def queryOptionOffsetDateTimeToTE(q: Query[Option[OffsetDateTime]]): QueryValueExpressionNode[Option[OffsetDateTime], TOptionOffsetDateTime] =
  ...
  implicit def queryOffsetDateTimeGroupedToTE(q: Query[Group[OffsetDateTime]]): QueryValueExpressionNode[OffsetDateTime, TOffsetDateTime] =
    new QueryValueExpressionNode[OffsetDateTime, TOffsetDateTime](q.copy(false, Nil).ast, offsetDateTimeTEF.createOutMapper)
  implicit def queryOptionOffsetDateTimeGroupedToTE(q: Query[Group[Option[OffsetDateTime]]]): QueryValueExpressionNode[Option[OffsetDateTime], TOptionOffsetDateTime] =
    new QueryValueExpressionNode[Option[OffsetDateTime], TOptionOffsetDateTime](q.copy(false, Nil).ast, optionOffsetDateTimeTEF.createOutMapper)
  implicit def queryOffsetDateTimeMeasuredToTE(q: Query[Measures[OffsetDateTime]]): QueryValueExpressionNode[OffsetDateTime, TOffsetDateTime] =
    new QueryValueExpressionNode[OffsetDateTime, TOffsetDateTime](q.copy(false, Nil).ast, offsetDateTimeTEF.createOutMapper)
  implicit def queryOptionOffsetDateTimeMeasuredToTE(q: Query[Measures[Option[OffsetDateTime]]]): QueryValueExpressionNode[Option[OffsetDateTime], TOptionOffsetDateTime] =
    new QueryValueExpressionNode[Option[OffsetDateTime], TOptionOffsetDateTime](q.copy(false, Nil).ast, optionOffsetDateTimeTEF.createOutMapper)
