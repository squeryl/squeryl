...
//      val a1 = 1.asInstanceOf[AnyRef].getClass
//      val z1 = classOf[java.lang.Long]
//      val z2 = classOf[java.lang.Integer]
      val x1 = wrappedFieldType.isAssignableFrom(classOf[java.lang.Long]) || wrappedFieldType.getName == "long"
      val x2 = wrappedFieldType.isAssignableFrom(classOf[java.lang.Integer]) || wrappedFieldType.getName == "int"
//
//      val x3 = classOf[java.lang.Long].isAssignableFrom(wrappedFieldType)
//      val x4 = classOf[java.lang.Integer].isAssignableFrom(wrappedFieldType)

      if(ca.isInstanceOf[AutoIncremented] && ! (x1 || x2))
