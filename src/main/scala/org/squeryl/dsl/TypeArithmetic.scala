...
trait TypeArithmetic extends FieldTypes {
  ...
  implicit def binaryOpConv51(op: BinaryAMSOp[BigDecimalType,ByteType]) = new NumericalTypeConversion[BigDecimalType](op)
  implicit def binaryOpConv52(op: BinaryAMSOp[BigDecimalType,IntType]) = new NumericalTypeConversion[BigDecimalType](op)
  implicit def binaryOpConv53(op: BinaryAMSOp[BigDecimalType,LongType]) = new NumericalTypeConversion[BigDecimalType](op)
  implicit def binaryOpConv54(op: BinaryAMSOp[BigDecimalType,FloatType]) = new NumericalTypeConversion[BigDecimalType](op)
  implicit def binaryOpConv55(op: BinaryAMSOp[BigDecimalType,DoubleType]) = new NumericalTypeConversion[BigDecimalType](op)
  implicit def binaryOpConv55bd(op: BinaryAMSOp[BigDecimalType,BigDecimalType]) = new NumericalTypeConversion[BigDecimalType](op)
  implicit def binaryOpConv56(op: BinaryAMSOp[BigDecimalType,Option[ByteType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv57(op: BinaryAMSOp[BigDecimalType,Option[IntType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv58(op: BinaryAMSOp[BigDecimalType,Option[LongType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv59(op: BinaryAMSOp[BigDecimalType,Option[FloatType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv60(op: BinaryAMSOp[BigDecimalType,Option[DoubleType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv60bd(op: BinaryAMSOp[BigDecimalType,Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv61(op: BinaryAMSOp[Option[ByteType],ByteType]) = new NumericalTypeConversion[Option[ByteType]](op)
  implicit def binaryOpConv62(op: BinaryAMSOp[Option[ByteType],IntType]) = new NumericalTypeConversion[Option[IntType]](op)
  implicit def binaryOpConv63(op: BinaryAMSOp[Option[ByteType],LongType]) = new NumericalTypeConversion[Option[LongType]](op)
  implicit def binaryOpConv64(op: BinaryAMSOp[Option[ByteType],FloatType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv65(op: BinaryAMSOp[Option[ByteType],DoubleType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv65bd(op: BinaryAMSOp[Option[ByteType],BigDecimalType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv66(op: BinaryAMSOp[Option[ByteType],Option[ByteType]]) = new NumericalTypeConversion[Option[ByteType]](op)
  implicit def binaryOpConv67(op: BinaryAMSOp[Option[ByteType],Option[IntType]]) = new NumericalTypeConversion[Option[IntType]](op)
  implicit def binaryOpConv68(op: BinaryAMSOp[Option[ByteType],Option[LongType]]) = new NumericalTypeConversion[Option[LongType]](op)
  implicit def binaryOpConv69(op: BinaryAMSOp[Option[ByteType],Option[FloatType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv70(op: BinaryAMSOp[Option[ByteType],Option[DoubleType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv70bd(op: BinaryAMSOp[Option[ByteType],Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv71(op: BinaryAMSOp[Option[IntType],ByteType]) = new NumericalTypeConversion[Option[IntType]](op)
  implicit def binaryOpConv72(op: BinaryAMSOp[Option[IntType],IntType]) = new NumericalTypeConversion[Option[IntType]](op)
  implicit def binaryOpConv73(op: BinaryAMSOp[Option[IntType],LongType]) = new NumericalTypeConversion[Option[LongType]](op)
  implicit def binaryOpConv74(op: BinaryAMSOp[Option[IntType],FloatType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv75(op: BinaryAMSOp[Option[IntType],DoubleType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv75bd(op: BinaryAMSOp[Option[IntType],BigDecimalType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv76(op: BinaryAMSOp[Option[IntType],Option[ByteType]]) = new NumericalTypeConversion[Option[IntType]](op)
  implicit def binaryOpConv77(op: BinaryAMSOp[Option[IntType],Option[IntType]]) = new NumericalTypeConversion[Option[IntType]](op)
  implicit def binaryOpConv78(op: BinaryAMSOp[Option[IntType],Option[LongType]]) = new NumericalTypeConversion[Option[LongType]](op)
  implicit def binaryOpConv79(op: BinaryAMSOp[Option[IntType],Option[FloatType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv80(op: BinaryAMSOp[Option[IntType],Option[DoubleType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv80bd(op: BinaryAMSOp[Option[IntType],Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv81(op: BinaryAMSOp[Option[LongType],ByteType]) = new NumericalTypeConversion[Option[LongType]](op)
  implicit def binaryOpConv82(op: BinaryAMSOp[Option[LongType],IntType]) = new NumericalTypeConversion[Option[LongType]](op)
  implicit def binaryOpConv83(op: BinaryAMSOp[Option[LongType],LongType]) = new NumericalTypeConversion[Option[LongType]](op)
  implicit def binaryOpConv84(op: BinaryAMSOp[Option[LongType],FloatType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv85(op: BinaryAMSOp[Option[LongType],DoubleType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv85bd(op: BinaryAMSOp[Option[LongType],BigDecimalType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv86(op: BinaryAMSOp[Option[LongType],Option[ByteType]]) = new NumericalTypeConversion[Option[LongType]](op)
  implicit def binaryOpConv87(op: BinaryAMSOp[Option[LongType],Option[IntType]]) = new NumericalTypeConversion[Option[LongType]](op)
  implicit def binaryOpConv88(op: BinaryAMSOp[Option[LongType],Option[LongType]]) = new NumericalTypeConversion[Option[LongType]](op)
  implicit def binaryOpConv89(op: BinaryAMSOp[Option[LongType],Option[FloatType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv90(op: BinaryAMSOp[Option[LongType],Option[DoubleType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv90bd(op: BinaryAMSOp[Option[LongType],Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv91(op: BinaryAMSOp[Option[FloatType],ByteType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv92(op: BinaryAMSOp[Option[FloatType],IntType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv93(op: BinaryAMSOp[Option[FloatType],LongType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv94(op: BinaryAMSOp[Option[FloatType],FloatType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv95(op: BinaryAMSOp[Option[FloatType],DoubleType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv95bd(op: BinaryAMSOp[Option[FloatType],BigDecimalType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv96(op: BinaryAMSOp[Option[FloatType],Option[ByteType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv97(op: BinaryAMSOp[Option[FloatType],Option[IntType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv98(op: BinaryAMSOp[Option[FloatType],Option[LongType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv99(op: BinaryAMSOp[Option[FloatType],Option[FloatType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv100(op: BinaryAMSOp[Option[FloatType],Option[DoubleType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv100bd(op: BinaryAMSOp[Option[FloatType],Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv101(op: BinaryAMSOp[Option[DoubleType],ByteType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv102(op: BinaryAMSOp[Option[DoubleType],IntType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv103(op: BinaryAMSOp[Option[DoubleType],LongType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv104(op: BinaryAMSOp[Option[DoubleType],FloatType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv105(op: BinaryAMSOp[Option[DoubleType],DoubleType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv105bd(op: BinaryAMSOp[Option[DoubleType],BigDecimalType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv106(op: BinaryAMSOp[Option[DoubleType],Option[ByteType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv107(op: BinaryAMSOp[Option[DoubleType],Option[IntType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv108(op: BinaryAMSOp[Option[DoubleType],Option[LongType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv109(op: BinaryAMSOp[Option[DoubleType],Option[FloatType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv110(op: BinaryAMSOp[Option[DoubleType],Option[DoubleType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv110bd(op: BinaryAMSOp[Option[DoubleType],Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv111(op: BinaryAMSOp[Option[BigDecimalType],ByteType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv112(op: BinaryAMSOp[Option[BigDecimalType],IntType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv113(op: BinaryAMSOp[Option[BigDecimalType],LongType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv114(op: BinaryAMSOp[Option[BigDecimalType],FloatType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv115(op: BinaryAMSOp[Option[BigDecimalType],DoubleType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv115bd(op: BinaryAMSOp[Option[BigDecimalType],BigDecimalType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv116(op: BinaryAMSOp[Option[BigDecimalType],Option[ByteType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv117(op: BinaryAMSOp[Option[BigDecimalType],Option[IntType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv118(op: BinaryAMSOp[Option[BigDecimalType],Option[LongType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv119(op: BinaryAMSOp[Option[BigDecimalType],Option[FloatType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv120(op: BinaryAMSOp[Option[BigDecimalType],Option[DoubleType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv120bd(op: BinaryAMSOp[Option[BigDecimalType],Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  ...
  implicit def binaryOpConv51(op: BinaryDivOp[BigDecimalType,ByteType]) = new NumericalTypeConversion[BigDecimalType](op)
  implicit def binaryOpConv52(op: BinaryDivOp[BigDecimalType,IntType]) = new NumericalTypeConversion[BigDecimalType](op)
  implicit def binaryOpConv53(op: BinaryDivOp[BigDecimalType,LongType]) = new NumericalTypeConversion[BigDecimalType](op)
  implicit def binaryOpConv54(op: BinaryDivOp[BigDecimalType,FloatType]) = new NumericalTypeConversion[BigDecimalType](op)
  implicit def binaryOpConv55(op: BinaryDivOp[BigDecimalType,DoubleType]) = new NumericalTypeConversion[BigDecimalType](op)
  implicit def binaryOpConv55bd(op: BinaryDivOp[BigDecimalType,BigDecimalType]) = new NumericalTypeConversion[BigDecimalType](op)
  implicit def binaryOpConv56(op: BinaryDivOp[BigDecimalType,Option[ByteType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv57(op: BinaryDivOp[BigDecimalType,Option[IntType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv58(op: BinaryDivOp[BigDecimalType,Option[LongType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv59(op: BinaryDivOp[BigDecimalType,Option[FloatType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv60(op: BinaryDivOp[BigDecimalType,Option[DoubleType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv60bd(op: BinaryDivOp[BigDecimalType,Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)  
  implicit def binaryOpConv61(op: BinaryDivOp[Option[ByteType],ByteType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv62(op: BinaryDivOp[Option[ByteType],IntType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv63(op: BinaryDivOp[Option[ByteType],LongType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv64(op: BinaryDivOp[Option[ByteType],FloatType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv65(op: BinaryDivOp[Option[ByteType],DoubleType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv65bd(op: BinaryDivOp[Option[ByteType],BigDecimalType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv66(op: BinaryDivOp[Option[ByteType],Option[ByteType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv67(op: BinaryDivOp[Option[ByteType],Option[IntType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv68(op: BinaryDivOp[Option[ByteType],Option[LongType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv69(op: BinaryDivOp[Option[ByteType],Option[FloatType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv70(op: BinaryDivOp[Option[ByteType],Option[DoubleType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv70bd(op: BinaryDivOp[Option[ByteType],Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv71(op: BinaryDivOp[Option[IntType],ByteType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv72(op: BinaryDivOp[Option[IntType],IntType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv73(op: BinaryDivOp[Option[IntType],LongType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv74(op: BinaryDivOp[Option[IntType],FloatType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv75(op: BinaryDivOp[Option[IntType],DoubleType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv75bd(op: BinaryDivOp[Option[IntType],BigDecimalType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv76(op: BinaryDivOp[Option[IntType],Option[ByteType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv77(op: BinaryDivOp[Option[IntType],Option[IntType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv78(op: BinaryDivOp[Option[IntType],Option[LongType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv79(op: BinaryDivOp[Option[IntType],Option[FloatType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv80(op: BinaryDivOp[Option[IntType],Option[DoubleType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv80bd(op: BinaryDivOp[Option[IntType],Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv81(op: BinaryDivOp[Option[LongType],ByteType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv82(op: BinaryDivOp[Option[LongType],IntType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv83(op: BinaryDivOp[Option[LongType],LongType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv84(op: BinaryDivOp[Option[LongType],FloatType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv85(op: BinaryDivOp[Option[LongType],DoubleType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv85bd(op: BinaryDivOp[Option[LongType],BigDecimalType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv86(op: BinaryDivOp[Option[LongType],Option[ByteType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv87(op: BinaryDivOp[Option[LongType],Option[IntType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv88(op: BinaryDivOp[Option[LongType],Option[LongType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv89(op: BinaryDivOp[Option[LongType],Option[FloatType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv90(op: BinaryDivOp[Option[LongType],Option[DoubleType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv90bd(op: BinaryDivOp[Option[LongType],Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv91(op: BinaryDivOp[Option[FloatType],ByteType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv92(op: BinaryDivOp[Option[FloatType],IntType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv93(op: BinaryDivOp[Option[FloatType],LongType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv94(op: BinaryDivOp[Option[FloatType],FloatType]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv95(op: BinaryDivOp[Option[FloatType],DoubleType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv95bd(op: BinaryDivOp[Option[FloatType],BigDecimalType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv96(op: BinaryDivOp[Option[FloatType],Option[ByteType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv97(op: BinaryDivOp[Option[FloatType],Option[IntType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv98(op: BinaryDivOp[Option[FloatType],Option[LongType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv99(op: BinaryDivOp[Option[FloatType],Option[FloatType]]) = new NumericalTypeConversion[Option[FloatType]](op)
  implicit def binaryOpConv100(op: BinaryDivOp[Option[FloatType],Option[DoubleType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv100bd(op: BinaryDivOp[Option[FloatType],Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv101(op: BinaryDivOp[Option[DoubleType],ByteType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv102(op: BinaryDivOp[Option[DoubleType],IntType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv103(op: BinaryDivOp[Option[DoubleType],LongType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv104(op: BinaryDivOp[Option[DoubleType],FloatType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv105(op: BinaryDivOp[Option[DoubleType],DoubleType]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv105bd(op: BinaryDivOp[Option[DoubleType],BigDecimalType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv106(op: BinaryDivOp[Option[DoubleType],Option[ByteType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv107(op: BinaryDivOp[Option[DoubleType],Option[IntType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv108(op: BinaryDivOp[Option[DoubleType],Option[LongType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv109(op: BinaryDivOp[Option[DoubleType],Option[FloatType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv110(op: BinaryDivOp[Option[DoubleType],Option[DoubleType]]) = new NumericalTypeConversion[Option[DoubleType]](op)
  implicit def binaryOpConv110bd(op: BinaryDivOp[Option[DoubleType],Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv111(op: BinaryDivOp[Option[BigDecimalType],ByteType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv112(op: BinaryDivOp[Option[BigDecimalType],IntType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv113(op: BinaryDivOp[Option[BigDecimalType],LongType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv114(op: BinaryDivOp[Option[BigDecimalType],FloatType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv115(op: BinaryDivOp[Option[BigDecimalType],DoubleType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv115bd(op: BinaryDivOp[Option[BigDecimalType],BigDecimalType]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv116(op: BinaryDivOp[Option[BigDecimalType],Option[ByteType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv117(op: BinaryDivOp[Option[BigDecimalType],Option[IntType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv118(op: BinaryDivOp[Option[BigDecimalType],Option[LongType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv119(op: BinaryDivOp[Option[BigDecimalType],Option[FloatType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv120(op: BinaryDivOp[Option[BigDecimalType],Option[DoubleType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
  implicit def binaryOpConv120bd(op: BinaryDivOp[Option[BigDecimalType],Option[BigDecimalType]]) = new NumericalTypeConversion[Option[BigDecimalType]](op)
