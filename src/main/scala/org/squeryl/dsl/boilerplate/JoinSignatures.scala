...
trait JoinSignatures {
  ...
  def join[A, B1, B2, C](q: Queryable[A], q1: JoinedQueryable[B1], q2: JoinedQueryable[B2])(
    f: Function3[A, B1, B2, JoinQueryYield2[C]]): Query[C] =
    from(q, q1, q2)(
  ...
  def join[A, B1, B2, B3, C](
    ...
    q3: JoinedQueryable[B3])(f: Function4[A, B1, B2, B3, JoinQueryYield3[C]]): Query[C] =
    from(q, q1, q2, q3)(
  ...
  def join[A, B1, B2, B3, B4, C](
    ...
    q4: JoinedQueryable[B4])(f: Function5[A, B1, B2, B3, B4, JoinQueryYield4[C]]): Query[C] =
    from(q, q1, q2, q3, q4)(
  ...
  def join[A, B1, B2, B3, B4, B5, C](
    ...
    q5: JoinedQueryable[B5])(f: Function6[A, B1, B2, B3, B4, B5, JoinQueryYield5[C]]): Query[C] =
  ...
  def join[A, B1, B2, B3, B4, B5, B6, C](
    ...
    q6: JoinedQueryable[B6])(f: Function7[A, B1, B2, B3, B4, B5, B6, JoinQueryYield6[C]]): Query[C] =
  ...
  def join[A, B1, B2, B3, B4, B5, B6, B7, C](
    ...
    q7: JoinedQueryable[B7])(f: Function8[A, B1, B2, B3, B4, B5, B6, B7, JoinQueryYield7[C]]): Query[C] =
  ...
  def join[A, B1, B2, B3, B4, B5, B6, B7, B8, C](
    ...
    q8: JoinedQueryable[B8])(f: Function9[A, B1, B2, B3, B4, B5, B6, B7, B8, JoinQueryYield8[C]]): Query[C] =
  ...
  def join[A, B1, B2, B3, B4, B5, B6, B7, B8, B9, C](
    ...
    q9: JoinedQueryable[B9])(f: Function10[A, B1, B2, B3, B4, B5, B6, B7, B8, B9, JoinQueryYield9[C]]): Query[C] =
