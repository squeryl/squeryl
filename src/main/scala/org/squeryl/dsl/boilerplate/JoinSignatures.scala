...
trait JoinSignatures {
  ...
  )(f: Function4[A, B1, B2, B3, JoinQueryYield3[C]]): Query[C] =
    from(q, q1, q2, q3)((a: A, b1: B1, b2: B2, b3: B3) => f(a, b1, b2, b3).queryYield)
  ...
  def join[A, B1, B2, B3, B4, C](
    ...
    from(q, q1, q2, q3, q4)((a: A, b1: B1, b2: B2, b3: B3, b4: B4) => f(a, b1, b2, b3, b4).queryYield)
  ...
  def join[A, B1, B2, B3, B4, B5, C](
    ...
    from(q, q1, q2, q3, q4, q5)((a: A, b1: B1, b2: B2, b3: B3, b4: B4, b5: B5) => f(a, b1, b2, b3, b4, b5).queryYield)
  ...
  def join[A, B1, B2, B3, B4, B5, B6, C](
    ...
    from(q, q1, q2, q3, q4, q5, q6)((a: A, b1: B1, b2: B2, b3: B3, b4: B4, b5: B5, b6: B6) =>
  ...
  def join[A, B1, B2, B3, B4, B5, B6, B7, C](
    ...
    from(q, q1, q2, q3, q4, q5, q6, q7)((a: A, b1: B1, b2: B2, b3: B3, b4: B4, b5: B5, b6: B6, b7: B7) =>
  ...
  def join[A, B1, B2, B3, B4, B5, B6, B7, B8, C](
    ...
    from(q, q1, q2, q3, q4, q5, q6, q7, q8)((a: A, b1: B1, b2: B2, b3: B3, b4: B4, b5: B5, b6: B6, b7: B7, b8: B8) =>
