...
class Query7[T1, T2, T3, T4, T5, T6, T7, R](
  ...
  def invokeYield(rsm: ResultSetMapper, rs: ResultSet): R =
    f(sq1.give(rs), sq2.give(rs), sq3.give(rs), sq4.give(rs), sq5.give(rs), sq6.give(rs), sq7.give(rs))
      .invokeYield(rsm, rs)
...
class Query8[T1, T2, T3, T4, T5, T6, T7, T8, R](
  ...
  def invokeYield(rsm: ResultSetMapper, rs: ResultSet): R =
    f(sq1.give(rs), sq2.give(rs), sq3.give(rs), sq4.give(rs), sq5.give(rs), sq6.give(rs), sq7.give(rs), sq8.give(rs))
      .invokeYield(rsm, rs)
...
class Query9[T1, T2, T3, T4, T5, T6, T7, T8, T9, R](
  ...
  def invokeYield(rsm: ResultSetMapper, rs: ResultSet): R =
    f(
      ...
      sq7.give(rs),
      sq8.give(rs),
      sq9.give(rs)).invokeYield(rsm, rs)
...
class Query10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R](
  ...
  def invokeYield(rsm: ResultSetMapper, rs: ResultSet): R =
    f(
      ...
      sq8.give(rs),
      sq9.give(rs),
      sq10.give(rs)).invokeYield(rsm, rs)
