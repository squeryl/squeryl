...
import internals.{FieldMapper, StatementWriter}
import dsl.ast.{ExpressionNode, ViewExpressionNode}
...
class PgSchema(implicit fieldMapper: FieldMapper) extends Schema()(fieldMapper) {
  ...
  private def srf0[T](name: String, prefix: Option[String], args: ExpressionNode*)(
    implicit man: Manifest[T]): View[T] = {
