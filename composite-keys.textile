...
*Note*: composite keys are a beta feature, supported as of commit 932ac571574586883db3 in the Git repository.
...
CourseAssignment.id is a unique identifier for a CourseAssignment. In this case *id* is what maked the class a KeyedEntity[CompositeKey2[Long,Long]]. A class can have any number of composite keys, a composite key is not necessarily a primary key.
