...
Relations allow foreign key relationships to appear as collection like objects. There are two types of relations in Squeryl : OneToMany and ManyToMany, and each has a statefull counterpart. 
...
Calling unConstrainReference in applyDefaultForeingKeyPolicy will cause foreing key constraints to be inhibited.    
